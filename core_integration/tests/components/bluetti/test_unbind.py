...
async def test_web_socket_message_handler_schedules_coordinator_refresh(hass):
    ...
    with patch("homeassistant.components.bluetti.models.asyncio.run_coroutine_threadsafe") as mock_run:
...
async def test_handle_unbind_full_cleanup(hass):
    ...
    with patch.object(hass.config_entries, "async_reload", AsyncMock()) as mock_reload, \
         patch("homeassistant.components.bluetti.models.persistent_notification.async_create") as mock_notify:
        await device._handle_unbind()
