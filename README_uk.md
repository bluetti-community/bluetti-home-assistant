...
|        Модель станції        |             Назва продукту              | Хмарне керування  | Керування BLE  | Статус інвертора | SOC батареї | Перемикач AC | Перемикач DC | Головний перемикач | AC ECO  | DC ECO  |   Режим роботи    |     Режим сну     | ФВ-вхідна потужність | мережева вхідна потужність | AC Змінна вихідна потужність | DC Змінна вихідна потужність |
|:----------------------------:|:---------------------------------------:|:-----------------:|:--------------:|:----------------:|:-----------:|:------------:|:------------:|:------------------:|:-------:|:-------:|:-----------------:|:-----------------:|:--------------------:|:--------------------------:|:----------------------------:|:----------------------------:| 
|            AP200             |                Apex 200                 |         ✅         |       ✅        |                 |      ✅         |     ✅     |           |             |   ✅    |        |        ✅         |     ✅      |       ✅        |        ✅         |        ✅        |        ✅        |
